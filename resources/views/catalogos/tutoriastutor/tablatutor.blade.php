...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-6">
                <form action="{{ route('tutoriastutor.tablatutor') }}" method="get">
        ...
        <div class="row mb-4">
            <div class="col text-end">
                <a href="{{ route('tutoriastutor.generarExcel') }}" class="btn btn-success">Descargar Reporte Excel</a>
            </div>
        </div>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="table-primary text-center">
                            <tr>
                                ...
                                <th scope="col">Status Seguimiento</th>
                                <th scope="col">Ver Rendimientos</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">{{ $tutorado->RegistroRendimientos }}</td>

                                <td class="text-center">
                                    <a href="{{ route('tutoriastutor.show', ['noctrl' => $tutorado->noctrl, 'idperiodo' => session('periodo_id')])  }}"><img src="{{ asset('img/icono-ver.png') }}" width="30px" alt="Ver detalles"></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
